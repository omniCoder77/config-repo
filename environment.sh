...
yay -S firefox intellij-idea-ultimate-edition mupdf unzip nvim flameshot xclip i3blocks zsh libreoffice alacritty
...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting fast-syntax-highlighting zsh-autocomplete archlinux colorize gradle postgres)
...
bindsym Ctrl+Shift+S exec systemctl poweroff
...
if [ $# -lt 3 ]; then
    ...
    echo "Example: $0 /path/to/project output.txt .kt .java .xml"
    exit 1
fi
...
ssh-keygen -t ed25519 -C "rishabh_2024bcse025@gmail.com"
eval "$(ssh-agent -s)"
